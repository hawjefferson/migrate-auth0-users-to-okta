signInWidgetConfig = {
   ...
   logo: '<your_logo>',           // Try changing "okta.com" to other domains, like: "workday.com", "splunk.com", or "delmonte.com"
   ...
   baseUrl: 'https://<your_subdomain>.okta.com',
   clientId: '0oa1igzxnbG7RHrTZ2p7',
   redirectUri: 'https://super-widget.oktaprise.com',
   authParams: {
     issuer: 'https://<your_subdomain>.okta.com/oauth2/default',
                      ...
                      console.log(data.migrated);
                        if (data.migrated === "True") {
                           callback();
                            ...
                            // resolve ( data)
                            //callback()
                            // do something here if migration failed
                        }
                     }
                });
            }
